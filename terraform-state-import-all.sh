...
sh terraform-state-import-repository.sh actions
sh terraform-state-import-repository.sh advent-of-code
sh terraform-state-import-repository.sh angular-playground
...
sh terraform-state-import-repository.sh open-webui-runner
